...
function location_modal_toogle(sender) {
  const btnContainer = sender;
  const locationModalContainer = document.getElementById(`${btnContainer.getAttribute('modalId')}`);
  locationModalContainer.classList.toggle('hidden')
}